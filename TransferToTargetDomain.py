...
def Test(args, model, test_source_dataloader, test_target_dataloader, Best_Acc, epoch, writer, dist_target_test):
    """Test."""
    ...
    'Situ_Acc: Situation_0 {six_acc[0].avg:.4f}\t Situation_1 {six_acc[1].avg:.4f}\t Situation_2 {six_acc[2].avg:.4f}\t Situation_3 {six_acc[3].avg:.4f}\t Situation_4 {six_acc[4].avg:.4f}\t Situation_5 {six_acc[5].avg:.4f}\n'\
    'Situ_Pro: Situation_0 {six_prob[0].avg:.4f}\t Situation_1 {six_prob[1].avg:.4f}\t Situation_2 {six_prob[2].avg:.4f}\t Situation_3 {six_prob[3].avg:.4f}\t Situation_4 {six_prob[4].avg:.4f}\t Situation_5 {six_prob[5].avg:.4f}\n \n'\
    .format(epoch, args.lr, Accuracys=accs, Recalls=recalls, Precisions=precs, F1=f1s, Loss=cls_loss, six_acc=six_accuracys, six_prob=six_probilities, acc_glg_value=acc_glg_value)
...
def main():
    ...
    train_source_dataloader, _, dist_source_train = BulidDataloader(args, flag1='train', flag2='source')
    train_target_dataloader, init_train_dataset_data, dist_target_train = BulidDataloader(args, flag1='train', flag2='target')
    test_source_dataloader, _, dist_source_test = BulidDataloader(args, flag1='test', flag2='source')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        Best_Accuracy = Test(args, model, test_source_dataloader, test_target_dataloader, Best_Accuracy, epoch, writer, dist_target_test)
